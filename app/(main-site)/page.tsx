...
export default async function HomePage() {
  ...
  // Dữ liệu cấu trúc JSON-LD định danh dịch vụ thiết kế web
  const jsonLd = {
    '@context': 'https://schema.org',
    '@type': 'ProfessionalService',
    'name': 'Long Web Studio',
    'image': 'https://i0.wp.com/longwebstudio.io.vn/wordpress/wp-content/uploads/2026/07/logo-og.jpg',
    'url': 'https://www.longwebstudio.io.vn',
    'telephone': '0966570913',
    'priceRange': '$$',
    'address': {
      '@type': 'PostalAddress',
    ...
    'description': 'Giải pháp xây dựng văn phòng số chuyên nghiệp cho nhân viên thu BHXH, BHYT. Tự động hóa bảng tính lương hưu và số hóa dịch vụ tư vấn.',
  };
  ...
  return (
    <div className="space-y-24 pb-20 overflow-hidden">
      ...
      {/* 3. Khối giải pháp đại lý thu BHXH & BHYT */}
      <InsuranceSolution />
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative isolate overflow-hidden bg-gray-950 px-6 py-16 text-center shadow-xl rounded-3xl sm:px-16 border border-gray-900">
          <h2 className="mx-auto max-w-2xl text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
            Sẵn sàng nâng tầm thương hiệu với văn phòng số?
          </h2>
          <p className="mx-auto mt-4 max-w-xl text-base leading-relaxed text-gray-400">
            Liên hệ ngay với Long Web Studio để nhận phác thảo giải pháp tự động hóa quy trình tư vấn hoàn toàn miễn phí.
          </p>
          <div className="mt-10 flex items-center justify-center">
            <Link href="/contact" className="rounded-xl bg-blue-600 px-6 py-3.5 text-sm font-bold text-white shadow-sm hover:bg-blue-500 transition-all">
              Bắt đầu dự án ngay
            </Link>
          </div>
        </div>
