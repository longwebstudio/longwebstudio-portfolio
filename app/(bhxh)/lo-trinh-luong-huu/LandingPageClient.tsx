...
import { User, CalendarDays, Shield,ShieldCheck, ClipboardList, ExternalLink } from 'lucide-react';
...
export default function LandingPageClient() {
  ...
  return (<><div className="min-h-screen bg-slate-100 text-slate-800 antialiased font-sans">
